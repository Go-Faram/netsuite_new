...
module NetSuiteNew
  module Utilities
    ...
    def clear_cache!
      if NetSuiteNew::Configuration.multi_tenant?
    ...
    def append_memo(ns_record, added_memo, opts = {})
      ...
      memo_key = if ns_record.class == NetSuiteNew::Records::Customer
        :comments
      else
        :memo
      end
    ...
    def netsuite_server_time(credentials={})
      server_time_response = NetSuiteNew::Utilities.backoff { NetSuiteNew::Configuration.connection({}, credentials).call(:get_server_time) }
    ...
    def netsuite_data_center_urls(account_id, credentials={})
      data_center_call_response = NetSuiteNew::Configuration.connection({
    ...
    def get_field_options(recordType, fieldName)
      options = NetSuiteNew::Records::BaseRefList.get_select_value(
        field: fieldName,
    ...
    def get_item(ns_item_internal_id, opts = {})
      ...
      ns_item = NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::InventoryItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::AssemblyItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::NonInventorySaleItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::NonInventoryResaleItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::DiscountItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::OtherChargeSaleItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::ServiceSaleItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::ServiceResaleItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::GiftCertificateItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::KitItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::ItemGroup, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::SerializedInventoryItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::SerializedAssemblyItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::LotNumberedAssemblyItem, ns_item_internal_id, opts)
      ns_item ||= NetSuiteNew::Utilities.get_record(NetSuiteNew::Records::LotNumberedInventoryItem, ns_item_internal_id, opts)

      if ns_item.nil?
        fail NetSuiteNew::RecordNotFound, "item with ID #{ns_item_internal_id} not found"
      end
    ...
    def get_record(record_klass, id, opts = {})
      ...
      begin
        ...
        return ns_record
      rescue ::NetSuiteNew::RecordNotFound
