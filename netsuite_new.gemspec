# -*- encoding: utf-8 -*-
require File.expand_path('../lib/netsuite_new/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.homepage      = 'https://github.com/NetSweet/netsuite_new'

  gem.executables   = `git ls-files -- bin/*`.split("\n").map{ |f| File.basename(f) }
  gem.files         = `git ls-files`.split("\n")
  gem.test_files    = `git ls-files -- {test,spec,features}/*`.split("\n")
  gem.name          = 'netsuite_new'
  gem.require_paths = ['lib']
  gem.version       = NetSuiteNew::VERSION
  gem.required_ruby_version = '>= 2.1'
  gem.metadata['changelog_uri'] = 'https://github.com/netsweet/netsuite_new/blob/master/HISTORY.md'
